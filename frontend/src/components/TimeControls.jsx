...
export default function TimeControls({ day, hour, onDay, onHour, initialNYCTime }) {
  return <section className="controls card" aria-label="Prediction time">
    <div className="control-intro"><span className="eyebrow">PLAN YOUR NEXT PICKUP</span><h2>When are you driving?</h2><p>NYC time at opening: {initialNYCTime}<br />Change the day or hour to explore.</p></div>
